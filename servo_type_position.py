from Raspi_MotorHAT.Raspi_PWM_Servo_Driver import PWM_Server
import atexit
...
#czas trwania w milisekundach impulsu potrzebnego do ustawienia serwmotoru w środkowej  pozycji
servo_mid_point_ms = 1.5

#Odchylenie 90 stopni przełożone na długość trwania impulsu w milisekundach
deflect_90_in_ms = 0.5

#Częstotliwość to 1 podzielone przez okres ale jako że używamy milisekundm zastosujemy 1000
period_in_ms = 1000 / pwm_frequency
#Nasz chi ma 4096 kroków w każdym okresie
pulse_steps = 4096
...
#środki ustawienie wyrażone liczbą kroków
